...
export function AdvertiserInfoModal({ isOpen, onClose }: AdvertiserInfoModalProps) {
  console.log("[v0] AdvertiserInfoModal rendered, isOpen:", isOpen)

  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-[90vw] max-w-[380px] sm:max-w-[430px] p-4 md:p-5 bg-white z-50">
        <DialogHeader className="pb-2">
          <DialogTitle className="text-center text-lg md:text-xl text-gray-900">Informação Publicitária</DialogTitle>
