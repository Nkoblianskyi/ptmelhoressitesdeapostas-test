      ...
      <div className="container mx-auto px-4 md:px-6 max-w-7xl relative z-10">
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white tracking-tight">
            ...
            <span className="block text-[#00D2BE] mt-2">sobre os Melhores Sites de Apostas</span>
          </h2>
          <p className="text-base md:text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Respostas às perguntas mais populares sobre as{" "}
            <span className="text-[#00D2BE] font-semibold">melhores plataformas de betting</span> e sites de apostas
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-12">
          <div className="group bg-gradient-to-br from-gray-900 to-black border border-[#00D2BE]/30 rounded-xl p-6 hover:border-[#00D2BE] transition-all duration-300 hover:shadow-lg hover:shadow-[#00D2BE]/20">
            <div className="flex items-start gap-3 mb-4">
              <div className="w-8 h-8 rounded-lg bg-[#00D2BE]/10 flex items-center justify-center flex-shrink-0 mt-1">
                <div className="w-4 h-4 border-2 border-[#00D2BE] rounded-full" />
              </div>
              <h3 className="text-lg font-bold text-[#00D2BE]">Como escolher o melhor site de apostas?</h3>
            </div>
          ...
          <div className="group bg-gradient-to-br from-gray-900 to-black border border-[#00D2BE]/30 rounded-xl p-6 hover:border-[#00D2BE] transition-all duration-300 hover:shadow-lg hover:shadow-[#00D2BE]/20">
            <div className="flex items-start gap-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-[#00D2BE]">
          ...
          <div className="group bg-gradient-to-br from-gray-900 to-black border border-[#00D2BE]/30 rounded-xl p-6 hover:border-[#00D2BE] transition-all duration-300 hover:shadow-lg hover:shadow-[#00D2BE]/20">
            <div className="flex items-start gap-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-[#00D2BE]">Que bónus oferecem os melhores sites de apostas?</h3>
            </div>
            <p className="text-sm text-gray-300 leading-relaxed pl-11">
        ...
        <div className="bg-gradient-to-br from-[#00D2BE]/5 via-black to-[#00D2BE]/5 border-2 border-[#00D2BE]/40 rounded-2xl p-8 md:p-10 backdrop-blur-sm text-center">
          ...
          <p className="text-sm md:text-base text-gray-300 leading-relaxed max-w-3xl mx-auto">
            ...
            <strong className="text-white">melhores sites de apostas</strong> ou{" "}
            <strong className="text-white">melhores plataformas de betting</strong>? Consulte as análises detalhadas de
