      ...
      <div className="container mx-auto px-4 md:px-6 max-w-7xl relative z-10">
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white tracking-tight">
            Apostas Desportivas
            <span className="block text-[#00D2BE] mt-2">em Portugal</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-12">
          <div className="bg-gradient-to-br from-gray-900 to-black border border-[#00D2BE]/30 rounded-xl p-6 hover:border-[#00D2BE] transition-all duration-300 hover:shadow-lg hover:shadow-[#00D2BE]/20">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-lg bg-[#00D2BE]/10 flex items-center justify-center">
                <div className="w-5 h-5 border-2 border-[#00D2BE] rounded-full" />
              </div>
              <h3 className="text-lg font-bold text-[#00D2BE]">Futebol</h3>
            </div>
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black border border-[#00D2BE]/30 rounded-xl p-6 hover:border-[#00D2BE] transition-all duration-300 hover:shadow-lg hover:shadow-[#00D2BE]/20">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-[#00D2BE]">Ténis</h3>
            </div>
            <p className="text-sm text-gray-300 leading-relaxed">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black border border-[#00D2BE]/30 rounded-xl p-6 hover:border-[#00D2BE] transition-all duration-300 hover:shadow-lg hover:shadow-[#00D2BE]/20">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-[#00D2BE]">Basquetebol</h3>
            </div>
            <p className="text-sm text-gray-300 leading-relaxed">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black border border-[#00D2BE]/30 rounded-xl p-6 hover:border-[#00D2BE] transition-all duration-300 hover:shadow-lg hover:shadow-[#00D2BE]/20">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-[#00D2BE]">Desportos Motorizados</h3>
            </div>
            <p className="text-sm text-gray-300 leading-relaxed">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black border border-[#00D2BE]/30 rounded-xl p-6 hover:border-[#00D2BE] transition-all duration-300 hover:shadow-lg hover:shadow-[#00D2BE]/20">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-[#00D2BE]">Desportos de Combate</h3>
            </div>
            <p className="text-sm text-gray-300 leading-relaxed">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black border border-[#00D2BE]/30 rounded-xl p-6 hover:border-[#00D2BE] transition-all duration-300 hover:shadow-lg hover:shadow-[#00D2BE]/20">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-[#00D2BE]">Outros Desportos</h3>
            </div>
            <p className="text-sm text-gray-300 leading-relaxed">
        ...
        <div className="bg-gradient-to-br from-gray-900/95 via-black/95 to-gray-900/95 border-2 border-[#00D2BE]/40 rounded-2xl p-8 md:p-12 backdrop-blur-sm shadow-2xl shadow-[#00D2BE]/10">
          <div className="mb-10">
            <div className="flex items-center gap-3 mb-6">
              <div className="h-12 w-1 bg-[#00D2BE]" />
              <h3 className="text-2xl md:text-3xl font-bold text-white">Sistema de Pontuação</h3>
            </div>
          ...
          <div className="space-y-6 mb-10">
            <div className="bg-black/40 border-l-4 border-[#00D2BE] rounded-r-xl p-6 hover:bg-black/60 transition-colors">
              <h4 className="text-lg font-bold text-[#00D2BE] mb-3">Variedade de Mercados</h4>
              <p className="text-sm text-gray-300 leading-relaxed">
            ...
            <div className="bg-black/40 border-l-4 border-[#00D2BE] rounded-r-xl p-6 hover:bg-black/60 transition-colors">
              <h4 className="text-lg font-bold text-[#00D2BE] mb-3">Competitividade das Odds</h4>
              <p className="text-sm text-gray-300 leading-relaxed">
            ...
            <div className="bg-black/40 border-l-4 border-[#00D2BE] rounded-r-xl p-6 hover:bg-black/60 transition-colors">
              <h4 className="text-lg font-bold text-[#00D2BE] mb-3">Funcionalidades e Usabilidade</h4>
              <p className="text-sm text-gray-300 leading-relaxed">
            ...
            <div className="bg-black/40 border-l-4 border-[#00D2BE] rounded-r-xl p-6 hover:bg-black/60 transition-colors">
              <h4 className="text-lg font-bold text-[#00D2BE] mb-3">Bónus e Promoções</h4>
              <p className="text-sm text-gray-300 leading-relaxed">
            ...
            <div className="bg-black/40 border-l-4 border-[#00D2BE] rounded-r-xl p-6 hover:bg-black/60 transition-colors">
              <h4 className="text-lg font-bold text-[#00D2BE] mb-3">Segurança e Suporte</h4>
              <p className="text-sm text-gray-300 leading-relaxed">
          ...
          <div className="pt-8 border-t border-[#00D2BE]/30">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-[#00D2BE]/10 to-black border-2 border-[#00D2BE] rounded-xl p-6 text-center">
                <div className="text-3xl md:text-4xl font-bold text-[#00D2BE] mb-2">9.0 - 10.0</div>
                <div className="text-base font-semibold text-white mb-3">Excelência</div>
                <div className="text-xs text-gray-400 leading-relaxed">
                  Plataformas premium com serviço superior em todas as categorias
                </div>
              </div>

              <div className="bg-gradient-to-br from-gray-800/50 to-black border-2 border-gray-500 rounded-xl p-6 text-center">
                <div className="text-3xl md:text-4xl font-bold text-gray-400 mb-2">7.5 - 8.9</div>
                <div className="text-base font-semibold text-white mb-3">Muito Bom</div>
                <div className="text-xs text-gray-400 leading-relaxed">
                  Casas de apostas confiáveis com excelente qualidade geral
                </div>
              </div>

              <div className="bg-gradient-to-br from-gray-800/30 to-black border-2 border-gray-600 rounded-xl p-6 text-center">
                <div className="text-3xl md:text-4xl font-bold text-gray-500 mb-2">6.0 - 7.4</div>
                <div className="text-base font-semibold text-white mb-3">Bom</div>
                <div className="text-xs text-gray-400 leading-relaxed">
