export function RatingMethodology() {
  return (
    <section className="py-12 md:py-20 bg-gradient-to-b from-portugal-sand/30 via-white to-portugal-sand/30 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-7xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-12">
          <div className="bg-gradient-to-br from-gray-200 to-white border border-[#00D2BE]/30 rounded-xl p-6 hover:border-[#00D2BE] transition-all duration-300 hover:shadow-lg hover:shadow-[#00D2BE]/20">
        ...
        <div className="bg-gradient-to-br from-white/95 via-portugal-sand/95 to-white/95 border-2 border-[#00D2BE]/40 rounded-2xl p-8 md:p-12 backdrop-blur-sm shadow-2xl shadow-[#00D2BE]/10">
          <div className="mb-10">
          ...
          <div className="space-y-6 mb-10">
            <div className="bg-white/40 border-l-4 border-[#00D2BE] rounded-r-xl p-6 hover:bg-white/60 transition-colors">
          ...
          <div className="pt-8 border-t border-[#00D2BE]/30">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-[#00D2BE]/10 to-white border-2 border-[#00D2BE] rounded-xl p-6 text-center">
