...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden max-h-[280px] sm:max-h-[320px] md:max-h-[350px] pt-14 md:pt-18 max-w-[1400px] mx-auto">
      ...
      <div className="container mx-auto sm:max-w-[1280px] relative z-10 px-2 sm:px-4">
        <div className="relative">
          <div className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 border border-mclaren-orange/30 shadow-2xl">
            <div className="text-center mb-2 sm:mb-3">
              <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-black mb-1 sm:mb-1.5 leading-tight">
                <span className="block">
                  <span className="text-mclaren-green">Melhores Sites </span>
                  <span className="text-mclaren-red">de</span>
                </span>
                <span className="block bg-gradient-to-r from-mclaren-orange via-mclaren-gold to-mclaren-orange bg-clip-text text-transparent">
                  Apostas em Portugal
                </span>
              </h1>
            ...
            <div className="text-center pt-1.5 sm:pt-2 border-t border-mclaren-orange/20">
          ...
          <div className="absolute -top-1 -left-1 w-8 sm:w-12 h-8 sm:h-12 border-t-2 border-l-2 border-mclaren-orange/30 rounded-tl-lg" />
          <div className="absolute -bottom-1 -right-1 w-8 sm:w-12 h-8 sm:h-12 border-b-2 border-r-2 border-mclaren-orange/30 rounded-br-lg" />
        </div>
      </div>
